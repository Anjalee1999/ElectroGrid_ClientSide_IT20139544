		 ...
		 <br>
            <div class="container col-md-5">
				...
				<form id="formConsumption" name="formConsumption" method="post" action="Consumption.jsp">  
					...
					<br> 
					Present Reading:  
					<input id="presentReading" name="presentReading" type="text" class="form-control form-control-sm">  
					
					<br>
					 Previous Reading:  
					 <input id="previousReading" name="previousReading" type="text" class="form-control form-control-sm">  
					 
					 <br> 
					 Consumption Unit:  
					 <input id="consumptionUnit" name="consumptionUnit" type="text" class="form-control form-control-sm">  
					 ...
					 <input type="hidden" id="hidcustomerIDSave" name="hidconsumptionIDSave" value=""> 
      ...
      <div class="container">
        <div class="row">
          <div class="col-sm-12 col-md-6">
            <h6>About</h6>
            <p class="text-justify">Kapukotuwa S.A.A.H<i> </i>PAF Project</p>
          </div>
          ...
          <div class="col-xs-6 col-md-3">
            ...
            <ul class="footer-links">
              ...
              <li><a href="Customer.jsp">Power Consumption Management</a></li>
